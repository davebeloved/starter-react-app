...
const Trade = () => {
  ...
  return (
    <section className='section lg:pt-[320px] bg-gradient-to-b from-[#f8f9fb] to-[#fafbff] text-darkblue lg:-mt-[120px]'>
          ...
          {currency.map((item, index) => {
            ...
            return (
              ...
              <div
                ...
                className={`${
                  name === itemName ? 'bg-darkblue text-white' : 'bg-white'
